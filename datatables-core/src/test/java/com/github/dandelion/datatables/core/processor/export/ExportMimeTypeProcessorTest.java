...
public class ExportMimeTypeProcessorTest extends TableProcessorBaseTest {

   @Override
   public OptionProcessor getProcessor() {
      return new ExportMimeTypeProcessor();
   }

   @Test
   public void should_configure_the_csv_init_export_with_a_custom_export_filename() {
      Option<?> option = DatatableOptions.EXPORT_CSV_MIMETYPE;
      entry = new MapEntry<Option<?>, Object>(option, "text/csv-custom");
      ...
      // Updated
      assertThat(ec.getMimeType()).isEqualTo("text/csv-custom");
