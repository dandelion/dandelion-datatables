...
public class ExportLabelProcessorTest extends TableProcessorBaseTest {

   @Override
   public OptionProcessor getProcessor() {
      return new ExportLabelProcessor();
   }

   @Test
   public void should_configure_the_csv_init_export_with_a_custom_export_filename() {
      Option<?> option = DatatableOptions.EXPORT_CSV_LABEL;
      entry = new MapEntry<Option<?>, Object>(option, "my-label");
      ...
      // Updated
      assertThat(ec.getLabel()).isEqualTo("my-label");
