...
public class PaginationTypeBootstrapFeatureTest  extends AbstractExtensionTest {
	...
	public void shoud_load_the_extension() {
		...
		assertThat(mainConfig).contains(entry(DTConstants.DT_PAGINATION_TYPE, "bootstrap"));
	}
}
