...
public class Bootstrap3ResponsiveThemeTest extends AbstractExtensionTest {

	@Test
	public void shoud_load_the_extension() {
		extensionProcessor.process(new HashSet<Extension>(Arrays.asList(new Bootstrap3ResponsiveTheme())));
