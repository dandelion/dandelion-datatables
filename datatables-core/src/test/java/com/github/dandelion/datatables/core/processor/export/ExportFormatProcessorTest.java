...
public class ExportFormatProcessorTest extends TableProcessorBaseTest{
	...
	public void should_configure_the_csv_init_export_with_a_custom_export_filename() {
		...
		processor.process(exportFilenameToken, "my-custom-filename.myformat", tableConfiguration, confToBeApplied);
	...
	public void should_init_export_with_a_custom_export_label() {
		...
		processor.process(exportLabelToken, "my-custom-label", tableConfiguration, confToBeApplied);
	...
	public void should_init_export_with_a_custom_export_class() {
		...
		processor.process(exportClassToken, "com.github.dandelion.datatables.core.export.CsvExport", tableConfiguration, confToBeApplied);
